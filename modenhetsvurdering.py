...
HENSIKT_TEKST = """
### Hensikt
Modenhetsvurderingen har som formal a synliggjore gode erfaringer og identifisere forbedringsomrader i vart arbeid med gevinster. Vi onsker a laere av hverandre, dele beste praksis og hjelpe initiativer til a lykkes bedre med a skape og realisere gevinster.

Et sentralt fokusomrade er a sikre at gevinstene vi arbeider med er konkrete og realitetsorienterte.

### Hvem inviteres?
Vi onsker a intervjue alle som har vaert eller er involvert i gevinstarbeidet.

### Hva vurderes?
Intervjuene dekker hele gevinstlivssyklusen - fra planlegging og gjennomforing til realisering og evaluering.

### Gevinster i endringsinitiativ
Et endringsinitiativ kan ha flere konkrete gevinster. Intervjuene kan gjennomfores med fokus pa en spesifikk gevinst, eller for initiativet som helhet.
"""

ROLES = {
    "Prosjektleder / Programleder": {
        "description": "Ansvar for overordnet gjennomforing og leveranser",
        "recommended_questions": {
            "Planlegging": [1, 2, 3, 4, 8, 9, 14, 16, 17, 18, 19, 20, 21, 22, 23],
            "Gjennomforing": [1, 2, 3, 4, 6, 8, 9, 14, 16, 17, 18, 19, 20, 21, 22, 23],
    ...
    "Gevinsteier": {
        ...
        "recommended_questions": {
            ...
            "Gjennomforing": [2, 6, 9, 10, 11, 12, 13, 16, 17, 20, 21],
            "Realisering": [1, 2, 3, 6, 8, 9, 10, 11, 12, 13, 16, 17, 20, 21],
            "Realisert": [1, 2, 6, 8, 11, 12, 13, 16, 17, 20, 21]
        }
    },
    "Gevinstansvarlig": {
        "description": "Operativt ansvar for oppfolging og rapportering av gevinster",
        "recommended_questions": {
            "Planlegging": [1, 3, 5, 6, 7, 9, 10, 11, 12, 13, 14, 15, 16, 17],
            "Gjennomforing": [1, 5, 6, 7, 9, 10, 11, 12, 13, 14, 15, 16, 17],
    ...
    "Linjeleder / Mottaker": {
        ...
        "recommended_questions": {
            ...
            "Gjennomforing": [2, 8, 9, 12, 13, 17, 18, 19, 20, 22, 24],
    ...
    "Business Case-ansvarlig": {
        ...
        "recommended_questions": {
            ...
            "Gjennomforing": [1, 5, 6, 7, 10, 11, 14, 15, 21],
    ...
    "Styringsgruppe": {
        ...
        "recommended_questions": {
            ...
            "Gjennomforing": [2, 4, 8, 14, 16, 19, 20, 22, 24],
            "Realisering": [2, 4, 8, 16, 19, 20, 22, 24],
            "Realisert": [2, 4, 8, 16, 19, 20, 22, 24]
        }
    },
    "Controller / Okonomi": {
        "description": "Oppfolging av okonomiske gevinster",
        "recommended_questions": {
            "Planlegging": [2, 4, 5, 6, 11, 12, 13, 21],
            "Gjennomforing": [2, 5, 6, 11, 12, 13, 21],
    ...
    "Endringsleder": {
        ...
        "recommended_questions": {
            ...
            "Gjennomforing": [2, 8, 9, 18, 19, 20, 22, 23, 24],
    ...
    "Interessent": {
        ...
        "recommended_questions": {
            ...
            "Gjennomforing": [8, 9, 12, 13, 18, 19, 22, 24],
...
PARAMETERS = {
    "Strategisk forankring": {"description": "Strategisk retning, kobling til mal og KPI-er", "questions": [2, 4]},
    ...
    "Gevinstrealiseringsplan": {"description": "Plan som operativt styringsverktoy", "questions": [16, 17]},
    "Effektivitet og produktivitet": {"description": "Maling, disponering og baerekraft", "questions": [12, 13]},
    "Laering og forbedring": {"description": "Bruk av tidligere erfaringer og kontinuerlig laering", "questions": [1]},
    "Momentum og tidlig gevinstuttak": {"description": "Bygge momentum gjennom tidlig gevinstrealisering", "questions": [5, 21, 22, 23]}
}

PHASES = ["Planlegging", "Gjennomforing", "Realisering", "Realisert"]

questions_data = {
    "Planlegging": [
        {"id": 1, "title": "Bruk av tidligere laering og gevinstdata", "question": "Hvordan anvendes erfaringer og laering fra tidligere prosjekter og gevinstarbeid i planleggingen av nye gevinster?", "scale": ["Niva 1: Ingen laering fra tidligere arbeid anvendt.", "Niva 2: Enkelte erfaringer omtalt, men ikke strukturert brukt.", "Niva 3: Laering inkludert i planlegging for enkelte omrader.", "Niva 4: Systematisk bruk av tidligere gevinstdata i planlegging og estimering.", "Niva 5: Kontinuerlig laering integrert i planleggingsprosessen og gevinststrategien."]},
        {"id": 2, "title": "Strategisk retning og gevinstforstaelse", "question": "Hvilke gevinster arbeider dere med, og hvorfor er de viktige for organisasjonens strategiske mal?", "scale": ["Niva 1: Gevinster er vagt definert, uten tydelig kobling til strategi.", "Niva 2: Gevinster er identifisert, men mangler klare kriterier og prioritering.", "Niva 3: Gevinster er dokumentert og delvis knyttet til strategiske mal, men grunnlaget har usikkerhet.", "Niva 4: Gevinster er tydelig koblet til strategiske mal med konkrete maltall.", "Niva 5: Gevinster er fullt integrert i styringssystemet og brukes i beslutninger."]},
        {"id": 3, "title": "Gevinstkart og visualisering", "question": "Er gevinstene synliggjort i gevinstkartet, med tydelig sammenheng mellom tiltak, effekter og mal?", "scale": ["Niva 1: Gevinstkart finnes ikke eller er utdatert.", "Niva 2: Et forelopig gevinstkart eksisterer, men dekker ikke hele omradet.", "Niva 3: Kartet inkluderer hovedgevinster, men mangler validering og detaljer.", "Niva 4: Kartet er brukt aktivt i planlegging og oppfolging.", "Niva 5: Gevinstkartet oppdateres kontinuerlig og er integrert i styringsdialoger."]},
        {"id": 4, "title": "Strategisk kobling og KPI-er", "question": "Er gevinstene tydelig knyttet til strategiske mal og eksisterende KPI-er?", "scale": ["Niva 1: Ingen kobling mellom gevinster og strategi eller KPI-er.", "Niva 2: Kobling er antatt, men ikke dokumentert.", "Niva 3: Kobling er etablert for enkelte KPI-er, men ikke konsistent.", "Niva 4: Tydelig kobling mellom gevinster og relevante KPI-er.", "Niva 5: Koblingen folges opp i styringssystem og rapportering."]},
        {"id": 5, "title": "Avgrensning av programgevinst", "question": "Er det tydelig avklart hvilke effekter som stammer fra programmet versus andre tiltak eller okte rammer?", "scale": ["Niva 1: Ingen skille mellom program- og eksterne effekter.", "Niva 2: Delvis omtalt, men uklart hva som er innenfor programmet.", "Niva 3: Avgrensning er gjort i plan, men ikke dokumentert grundig.", "Niva 4: Avgrensning er dokumentert og anvendt i beregninger.", "Niva 5: Effektisolering er standard praksis og brukes systematisk."]},
        {"id": 6, "title": "Nullpunkter og estimater", "question": "Er nullpunkter og estimater etablert, testet og dokumentert pa en konsistent og troverdig mate?", "scale": ["Niva 1: Nullpunkter mangler eller bygger pa uprovde antagelser.", "Niva 2: Enkelte nullpunkter finnes, men uten felles metode.", "Niva 3: Nullpunkter og estimater er definert, men med hoy usikkerhet.", "Niva 4: Nullpunkter og estimater er basert pa testede data og validerte metoder.", "Niva 5: Nullpunkter og estimater kvalitetssikres jevnlig og brukes aktivt til laering."]},
        {"id": 7, "title": "Hypotesetesting og datagrunnlag", "question": "Finnes formell prosess for hypotesetesting pa representative caser?", "scale": ["Niva 1: Ikke etablert/uklart; ingen dokumenterte praksiser.", "Niva 2: Delvis definert; uformell praksis uten forankring/validering.", "Niva 3: Etablert for deler av omradet; variabel kvalitet.", "Niva 4: Godt forankret og systematisk anvendt; males og folges opp.", "Niva 5: Fullt integrert i styring; kontinuerlig forbedring og laering."]},
        ...
        {"id": 9, "title": "Gevinstforutsetninger", "question": "Er alle vesentlige forutsetninger ivaretatt for a muliggjore gevinstrealisering?", "scale": ["Niva 1: Ingen kartlegging av gevinstforutsetninger.", "Niva 2: Noen forutsetninger er identifisert, men ikke systematisk dokumentert.", "Niva 3: Hovedforutsetninger er dokumentert, men uten klar eierskap.", "Niva 4: Alle kritiske forutsetninger er kartlagt med tildelt ansvar.", "Niva 5: Gevinstforutsetninger er integrert i risikostyring og oppfolges kontinuerlig."]},
        {"id": 10, "title": "Prinsipielle og vilkarsmessige kriterier", "question": "Er forutsetninger og kriterier som pavirker gevinstene tydelig definert og dokumentert?", "scale": ["Niva 1: Ingen kriterier dokumentert.", "Niva 2: Kriterier er beskrevet uformelt.", "Niva 3: Kriterier dokumentert i deler av planverket.", "Niva 4: Vesentlige kriterier er analysert og handtert i gevinstrealiseringsplanen.", "Niva 5: Kriterier overvakes, folges opp og inngar i risikostyringen."]},
        {"id": 11, "title": "Enighet om nullpunkter/estimater", "question": "Er det oppnadd enighet blant nokkelinteressenter om nullpunkter og estimater?", "scale": ["Niva 1: Ingen enighet eller dokumentert praksis.", "Niva 2: Delvis enighet, men ikke formalisert.", "Niva 3: Enighet for hovedestimater, men med reservasjoner.", "Niva 4: Full enighet dokumentert og forankret.", "Niva 5: Kontinuerlig dialog og justering av estimater med interessentene."]},
        {"id": 12, "title": "Disponering av kostnads- og tidsbesparelser", "question": "Hvordan er kostnads- og tidsbesparelser planlagt disponert mellom prissatte og ikke-prissatte gevinster?", "scale": ["Niva 1: Ingen plan for disponering eller maling av besparelser.", "Niva 2: Delvis oversikt, men ikke dokumentert eller fulgt opp.", "Niva 3: Plan finnes for enkelte omrader, men uten systematikk.", "Niva 4: Disponering og effekter dokumentert og malt.", "Niva 5: Frigjorte ressurser disponeres strategisk og males som del av gevinstrealiseringen."]},
        {"id": 13, "title": "Maling av effektivitet og produktivitet", "question": "Hvordan males okt effektivitet og produktivitet som folge av besparelser?", "scale": ["Niva 1: Ingen maling av effektivitet eller produktivitet.", "Niva 2: Enkelte malinger, men ikke systematisk.", "Niva 3: Maling for enkelte gevinster, men begrenset fokus pa baerekraft.", "Niva 4: Systematisk maling og vurdering av om gevinster opprettholdes over tid.", "Niva 5: Maling integrert i gevinstoppfolgingen, baerekraftige gevinster sikres."]},
        {"id": 14, "title": "Operasjonell risiko og ulemper", "question": "Er mulige negative konsekvenser eller ulemper knyttet til operasjonelle forhold identifisert, vurdert og handtert i planen?", "scale": ["Niva 1: Negative effekter ikke vurdert.", "Niva 2: Kjent, men ikke handtert.", "Niva 3: Beskrevet, men ikke fulgt opp systematisk.", "Niva 4: Handtert og overvaket med tilpasning til ulike operasjonelle scenarier.", "Niva 5: Systematisk vurdert og del av gevinstdialogen med kontinuerlig justering."]},
        {"id": 15, "title": "Balanse mellom gevinster og ulemper", "question": "Hvordan sikres det at balansen mellom gevinster og ulemper vurderes i styringsdialoger?", "scale": ["Niva 1: Ingen vurdering av balanse.", "Niva 2: Diskuteres uformelt.", "Niva 3: Del av enkelte oppfolgingsmoter.", "Niva 4: Systematisk vurdert i gevinststyring.", "Niva 5: Inngar som fast punkt i styrings- og gevinstdialoger."]},
        {"id": 16, "title": "Dokumentasjon og gevinstrealiseringsplan", "question": "Er det utarbeidet en forankret gevinstrealiseringsplan som beskriver hvordan gevinstene skal hentes ut og males?", "scale": ["Niva 1: Ingen formell gevinstrealiseringsplan.", "Niva 2: Utkast til plan finnes, men er ufullstendig.", "Niva 3: Plan er etablert, men ikke validert eller periodisert.", "Niva 4: Planen er forankret, oppdatert og koblet til gevinstkartet.", "Niva 5: Planen brukes aktivt som styringsdokument med revisjon."]},
        {"id": 17, "title": "Gevinstrealiseringsplan som operativ handlingsplan", "question": "Hvordan sikres det at gevinstrealiseringsplanen fungerer som en operativ handlingsplan i linjen med tilpasning til ulike strekningsforhold?", "scale": ["Niva 1: Planen brukes ikke som operativt styringsverktoy.", "Niva 2: Plan finnes, men uten operativ oppfolging.", "Niva 3: Planen folges delvis opp i linjen.", "Niva 4: Planen brukes aktivt som handlingsplan og styringsverktoy.", "Niva 5: Gevinstplanen er fullt operativt integrert i linjens handlingsplaner og rapportering med tilpasning til lokale forhold."]},
        {"id": 18, "title": "Endringsberedskap og operativ mottaksevne", "question": "Er organisasjonen forberedt og har den tilstrekkelig kapasitet til a ta imot endringer og nye arbeidsformer som folger av programmet?", "scale": ["Niva 1: Ingen plan for endringsberedskap.", "Niva 2: Kapasitet vurderes uformelt, men ikke handtert.", "Niva 3: Endringskapasitet omtales, men uten konkrete tiltak.", "Niva 4: Tilfredsstillende beredskap etablert og koordinert med linjen.", "Niva 5: Endringskapasitet er strukturert, overvaket og integrert i styring med tilpasning til lokale forhold."]},
        {"id": 19, "title": "Kommunikasjon og forankring", "question": "Er gevinstgrunnlag, roller og forventninger godt kommunisert i organisasjonen?", "scale": ["Niva 1: Ingen felles forstaelse eller kommunikasjon.", "Niva 2: Informasjon deles sporadisk.", "Niva 3: Kommunikasjon er planlagt, men ikke systematisk malt.", "Niva 4: Kommunikasjon er systematisk og forankret i organisasjonen.", "Niva 5: Forankring skjer lopende som del av styringsdialog."]},
        {"id": 20, "title": "Eierskap og ansvar", "question": "Er ansvar og roller tydelig definert for a sikre gjennomforing og gevinstuttak?", "scale": ["Niva 1: Ansvar er uklart eller mangler.", "Niva 2: Ansvar er delvis definert, men ikke praktisert.", "Niva 3: Ansvar er kjent, men samhandling varierer.", "Niva 4: Roller og ansvar fungerer godt i praksis.", "Niva 5: Sterkt eierskap og kultur for ansvarliggjoring."]},
        ...
        {"id": 24, "title": "Enighet og lojalitet til gevinster", "question": "Er det etablert tilstrekkelig enighet og lojalitet til de definerte gevinstene blant berort personell gjennom endringsledelsesarbeidet?", "scale": ["Niva 1: Ingen systematisk arbeid med a bygge enighet eller lojalitet til gevinstene.", "Niva 2: Begrenset endringsledelsesarbeid - enighet og lojalitet er ikke vurdert.", "Niva 3: Endringsledelse er planlagt, men effekten pa enighet og lojalitet er usikker.", "Niva 4: Systematisk endringsledelse med dokumentert tilslutning fra hovedinteressenter.", "Niva 5: Omfattende endringsledelse har skapt bred enighet og aktiv lojalitet til gevinstene i berort organisasjon."]}
    ],
    "Gjennomforing": [
        {"id": 1, "title": "Bruk av tidligere laering og gevinstdata", "question": "Hvordan brukes erfaringer og laering fra tidligere prosjekter og gevinstarbeid til a justere tiltak under gjennomforingen?", "scale": ["Niva 1: Ingen laering fra tidligere arbeid anvendt under gjennomforing.", "Niva 2: Enkelte erfaringer omtalt, men ikke strukturert brukt for justering.", "Niva 3: Laering inkludert i justering for enkelte omrader under gjennomforing.", "Niva 4: Systematisk bruk av tidligere gevinstdata for a justere tiltak underveis.", "Niva 5: Kontinuerlig laering integrert i gjennomforingsprosessen og gevinstjustering."]},
        {"id": 2, "title": "Strategisk retning og gevinstforstaelse", "question": "Hvordan opprettholdes den strategiske retningen og forstaelsen av gevinster under gjennomforing?", "scale": ["Niva 1: Strategisk kobling glemmes under gjennomforing.", "Niva 2: Strategi omtales, men ikke operasjonalisert i gjennomforing.", "Niva 3: Strategisk kobling vedlikeholdes i deler av gjennomforingen.", "Niva 4: Tydelig strategisk retning i gjennomforing med regelmessig oppdatering.", "Niva 5: Strategi og gevinstforstaelse dynamisk tilpasses underveis basert pa laering."]},
        {"id": 3, "title": "Gevinstkart og visualisering", "question": "Hvordan brukes gevinstkartet aktivt under gjennomforing for a styre og kommunisere fremdrift?", "scale": ["Niva 1: Gevinstkartet brukes ikke under gjennomforing.", "Niva 2: Gevinstkartet vises, men ikke aktivt brukt.", "Niva 3: Gevinstkartet oppdateres og brukes i noen beslutninger.", "Niva 4: Gevinstkartet er aktivt styringsverktoy under gjennomforing.", "Niva 5: Gevinstkartet brukes dynamisk til a justere strategi og tiltak underveis."]},
        {"id": 4, "title": "Strategisk kobling og KPI-er", "question": "Hvordan folges opp den strategiske koblingen og KPI-ene under gjennomforing?", "scale": ["Niva 1: Ingen oppfolging av strategisk kobling under gjennomforing.", "Niva 2: KPI-er males, men kobling til strategi mangler.", "Niva 3: Noen KPI-er folges opp med strategisk kobling.", "Niva 4: Systematisk oppfolging av KPI-er med tydelig strategisk kobling.", "Niva 5: Dynamisk justering av KPI-er basert pa strategisk utvikling underveis."]},
        {"id": 5, "title": "Avgrensning av programgevinst", "question": "Hvordan handteres avgrensning av programgevinster under gjennomforing nar nye forhold oppstar?", "scale": ["Niva 1: Avgrensning glemmes under gjennomforing.", "Niva 2: Avgrensning omtales, men ikke operasjonalisert.", "Niva 3: Avgrensning handteres for storre endringer.", "Niva 4: System for a handtere avgrensning under gjennomforing.", "Niva 5: Dynamisk avgrensningshandtering integrert i beslutningsprosesser."]},
        {"id": 6, "title": "Nullpunkter og estimater", "question": "Hvordan justeres nullpunkter og estimater under gjennomforing basert pa nye data og erfaringer?", "scale": ["Niva 1: Nullpunkter og estimater justeres ikke under gjennomforing.", "Niva 2: Justering skjer ad hoc uten struktur.", "Niva 3: Systematisk justering for store avvik.", "Niva 4: Regelmessig revisjon og justering av nullpunkter og estimater.", "Niva 5: Kontinuerlig justering basert pa realtidsdata og laering."]},
        {"id": 7, "title": "Hypotesetesting og datagrunnlag", "question": "Hvordan testes hypoteser og datagrunnlag under gjennomforing for a validere tilnaermingen?", "scale": ["Niva 1: Hypoteser testes ikke under gjennomforing.", "Niva 2: Noen uformelle tester gjennomfores.", "Niva 3: Formell testing for kritiske hypoteser.", "Niva 4: Systematisk testing og validering under gjennomforing.", "Niva 5: Kontinuerlig hypotesetesting integrert i laeringsprosesser."]},
        {"id": 8, "title": "Interessentengasjement", "question": "Hvordan opprettholdes interessentengasjement under gjennomforing?", "scale": ["Niva 1: Interessentengasjement avtar under gjennomforing.", "Niva 2: Begrenset engasjement for viktige beslutninger.", "Niva 3: Regelmessig engasjement for storre endringer.", "Niva 4: Systematisk interessentoppfolging under gjennomforing.", "Niva 5: Kontinuerlig dialog og samskaping med interessenter."]},
        {"id": 9, "title": "Gevinstforutsetninger", "question": "Hvordan overvakes og handteres gevinstforutsetninger under gjennomforing?", "scale": ["Niva 1: Forutsetninger overvakes ikke under gjennomforing.", "Niva 2: Noen forutsetninger overvakes uformelt.", "Niva 3: Systematisk overvaking av kritiske forutsetninger.", "Niva 4: Aktiv handtering av endrede forutsetninger.", "Niva 5: Forutsetningsstyring integrert i risikostyring og beslutninger."]},
        {"id": 10, "title": "Prinsipielle og vilkarsmessige kriterier", "question": "Hvordan handteres endringer i prinsipielle og vilkarsmessige kriterier under gjennomforing?", "scale": ["Niva 1: Endringer i kriterier handteres ikke.", "Niva 2: Store endringer handteres reaktivt.", "Niva 3: System for a handtere endringer i kriterier.", "Niva 4: Proaktiv handtering av endrede kriterier.", "Niva 5: Dynamisk tilpasning til endrede kriterier i sanntid."]},
        {"id": 11, "title": "Enighet om nullpunkter/estimater", "question": "Hvordan opprettholdes enighet om nullpunkter og estimater under gjennomforing?", "scale": ["Niva 1: Enighet testes ikke under gjennomforing.", "Niva 2: Enighet bekreftes ved store endringer.", "Niva 3: Regelmessig bekreftelse av enighet.", "Niva 4: Systematisk arbeid for a opprettholde enighet.", "Niva 5: Kontinuerlig dialog og justering for a opprettholde enighet."]},
        {"id": 12, "title": "Disponering av kostnads- og tidsbesparelser", "question": "Hvordan handteres disponering av besparelser under gjennomforing?", "scale": ["Niva 1: Disponering handteres ikke under gjennomforing.", "Niva 2: Disponering justeres for store avvik.", "Niva 3: Systematisk revisjon av disponeringsplaner.", "Niva 4: Dynamisk tilpasning av disponering basert pa resultater.", "Niva 5: Optimal disponering integrert i beslutningsstotte."]},
        {"id": 13, "title": "Maling av effektivitet og produktivitet", "question": "Hvordan males og folges opp effektivitet og produktivitet under gjennomforing?", "scale": ["Niva 1: Effektivitet og produktivitet males ikke underveis.", "Niva 2: Noen malinger registreres, men ikke analysert.", "Niva 3: Systematisk maling med begrenset analyse.", "Niva 4: Regelmessig analyse og justering basert pa malinger.", "Niva 5: Realtids overvaking og proaktiv justering."]},
        {"id": 14, "title": "Operasjonell risiko og ulemper", "question": "Hvordan identifiseres og handteres nye operasjonelle risikoer og ulemper under gjennomforing?", "scale": ["Niva 1: Nye risikoer identifiseres ikke underveis.", "Niva 2: Store risikoer handteres reaktivt.", "Niva 3: Systematisk identifisering av nye risikoer.", "Niva 4: Proaktiv handtering av nye risikoer.", "Niva 5: Risikostyring integrert i daglig drift."]},
        {"id": 15, "title": "Balanse mellom gevinster og ulemper", "question": "Hvordan vurderes balansen mellom gevinster og ulemper under gjennomforing?", "scale": ["Niva 1: Balansen vurderes ikke under gjennomforing.", "Niva 2: Balansen vurderes ved store endringer.", "Niva 3: Regelmessig vurdering av balansen.", "Niva 4: Systematisk overvaking av balansen.", "Niva 5: Balansevurdering integrert i beslutningsprosesser."]},
        {"id": 16, "title": "Dokumentasjon og gevinstrealiseringsplan", "question": "Hvordan oppdateres og brukes gevinstrealiseringsplanen under gjennomforing?", "scale": ["Niva 1: Gevinstrealiseringsplanen oppdateres ikke.", "Niva 2: Planen oppdateres ved store endringer.", "Niva 3: Regelmessig oppdatering av planen.", "Niva 4: Planen brukes aktivt i styring og beslutninger.", "Niva 5: Dynamisk oppdatering og bruk av planen i sanntid."]},
        {"id": 17, "title": "Gevinstrealiseringsplan som operativ handlingsplan", "question": "Hvordan fungerer gevinstrealiseringsplanen som operativ handlingsplan under gjennomforing?", "scale": ["Niva 1: Planen brukes ikke som operativ handlingsplan.", "Niva 2: Planen brukes til visse operasjoner.", "Niva 3: Planen er integrert i deler av den operative styringen.", "Niva 4: Planen er aktivt operativt styringsverktoy.", "Niva 5: Planen er fullt integrert i alle operative beslutninger."]},
        {"id": 18, "title": "Endringsberedskap og operativ mottaksevne", "question": "Hvordan utvikles endringsberedskap og operativ mottaksevne under gjennomforing?", "scale": ["Niva 1: Endringsberedskap utvikles ikke underveis.", "Niva 2: Begrenset fokus pa endringsberedskap.", "Niva 3: Systematisk arbeid med endringsberedskap.", "Niva 4: Malrettet utvikling av mottaksevne.", "Niva 5: Kontinuerlig tilpasning og laering i endringsprosessen."]},
        {"id": 19, "title": "Kommunikasjon og forankring", "question": "Hvordan opprettholdes kommunikasjon og forankring under gjennomforing?", "scale": ["Niva 1: Kommunikasjon avtar under gjennomforing.", "Niva 2: Begrenset kommunikasjon om viktige endringer.", "Niva 3: Regelmessig kommunikasjon om fremdrift.", "Niva 4: Systematisk kommunikasjonsplan under gjennomforing.", "Niva 5: Kontinuerlig dialog og tilbakemelding integrert i prosessen."]},
        {"id": 20, "title": "Eierskap og ansvar", "question": "Hvordan utoves eierskap og ansvar under gjennomforing?", "scale": ["Niva 1: Eierskap og ansvar svekkes under gjennomforing.", "Niva 2: Begrenset eierskap i kritiske faser.", "Niva 3: Tydelig eierskap for sentrale ansvarsomrader.", "Niva 4: Aktivt utovd eierskap gjennom hele prosessen.", "Niva 5: Sterk eierskapskultur som driver gjennomforing."]},
        {"id": 21, "title": "Periodisering og forankring", "question": "Hvordan justeres periodisering og forankring under gjennomforing?", "scale": ["Niva 1: Periodisering justeres ikke under gjennomforing.", "Niva 2: Store justeringer i periodisering.", "Niva 3: Regelmessig revisjon av periodisering.", "Niva 4: Dynamisk tilpasning av periodisering.", "Niva 5: Fleksibel periodisering integrert i styringssystemet."]},
        {"id": 22, "title": "Realisme og engasjement", "question": "Hvordan opprettholdes realisme og engasjement under gjennomforing?", "scale": ["Niva 1: Realisme og engasjement avtar.", "Niva 2: Begrenset fokus pa a opprettholde engasjement.", "Niva 3: Arbeid med a opprettholde realisme og engasjement.", "Niva 4: Systematisk arbeid for a styrke troverdighet.", "Niva 5: Hoy troverdighet og engasjement gjennom hele prosessen."]},
        {"id": 23, "title": "Bygge momentum og tidlig gevinstuttak", "question": "Hvordan bygges momentum gjennom tidlig gevinstuttak under gjennomforingsfasen?", "scale": ["Niva 1: Ingen fokus pa momentum eller tidlig gevinstuttak.", "Niva 2: Noen tidlige gevinster realiseres, men uten strategi.", "Niva 3: Planlagt for tidlig gevinstuttak, men begrenset gjennomforing.", "Niva 4: Systematisk arbeid med tidlig gevinstuttak for a bygge momentum.", "Niva 5: Kontinuerlig fokus pa momentum gjennom suksessiv gevinstrealisering."]},
        {"id": 24, "title": "Enighet og lojalitet til gevinster", "question": "I hvilken grad oppleves det at endringsledelsesarbeidet har skapt reell enighet og lojalitet til gevinstene blant berort personell under gjennomforingen?", "scale": ["Niva 1: Lav enighet - motstand eller likegyldighet til gevinstmalene i berort organisasjon.", "Niva 2: Delvis enighet - noen grupper stotter gevinstene, men betydelig motstand finnes.", "Niva 3: Moderat enighet - flertallet aksepterer gevinstene, men engasjementet varierer.", "Niva 4: Hoy enighet - bred aksept og stotte til gevinstene, med aktiv deltakelse i gjennomforing.", "Niva 5: Full lojalitet - gevinstene er internalisert som felles mal, berort personell bidrar proaktivt til a na dem."]}
    ],
    "Realisering": [
        {"id": 1, "title": "Bruk av tidligere laering og gevinstdata", "question": "Hvordan anvendes laering fra tidligere prosjekter og gevinstarbeid for a optimalisere gevinstuttak under realiseringen?", "scale": ["Niva 1: Ingen laering anvendt i realiseringsfasen.", "Niva 2: Enkelte erfaringer tas i betraktning.", "Niva 3: Systematisk bruk av laering for a optimalisere uttak.", "Niva 4: Laering integrert i realiseringsprosessen.", "Niva 5: Kontinuerlig laering og optimalisering under realisering."]},
        ...
        {"id": 4, "title": "Strategisk kobling og KPI-er", "question": "Hvordan folges opp strategisk kobling og KPI-er under realiseringen?", "scale": ["Niva 1: Ingen oppfolging av strategisk kobling.", "Niva 2: KPI-er males, men kobling til strategi svak.", "Niva 3: Systematisk oppfolging av strategisk kobling.", "Niva 4: Dynamisk justering basert pa KPI-utvikling.", "Niva 5: Full integrasjon mellom strategi, KPI-er og realisering."]},
        {"id": 5, "title": "Avgrensning av programgevinst", "question": "Hvordan handteres avgrensning av programgevinster under realiseringen?", "scale": ["Niva 1: Avgrensning handteres ikke under realisering.", "Niva 2: Store avgrensningsutfordringer handteres.", "Niva 3: System for a handtere avgrensning.", "Niva 4: Proaktiv handtering av avgrensning.", "Niva 5: Avgrensning integrert i realiseringsprosessen."]},
        {"id": 6, "title": "Nullpunkter og estimater", "question": "Hvordan valideres og justeres nullpunkter og estimater under realiseringen?", "scale": ["Niva 1: Nullpunkter og estimater valideres ikke.", "Niva 2: Store avvik handteres reaktivt.", "Niva 3: Systematisk validering under realisering.", "Niva 4: Kontinuerlig justering basert pa realisering.", "Niva 5: Dynamisk oppdatering av nullpunkter og estimater."]},
        ...
        {"id": 9, "title": "Gevinstforutsetninger", "question": "Hvordan overvakes og realiseres gevinstforutsetninger under realiseringen?", "scale": ["Niva 1: Forutsetninger overvakes ikke under realisering.", "Niva 2: Noen forutsetninger folges opp.", "Niva 3: Systematisk overvaking av forutsetninger.", "Niva 4: Aktiv realisering av forutsetninger.", "Niva 5: Forutsetningsrealisering integrert i gevinstuttak."]},
        {"id": 10, "title": "Prinsipielle og vilkarsmessige kriterier", "question": "Hvordan handteres prinsipielle og vilkarsmessige kriterier under realiseringen?", "scale": ["Niva 1: Kriterier handteres ikke under realisering.", "Niva 2: Store avvik fra kriterier handteres.", "Niva 3: Systematisk handtering av kriterier.", "Niva 4: Proaktiv tilpasning til kriterier.", "Niva 5: Kriterier integrert i realiseringsbeslutninger."]},
        ...
        {"id": 12, "title": "Disponering av kostnads- og tidsbesparelser", "question": "Hvordan handteres disponering av besparelser under realiseringen?", "scale": ["Niva 1: Disponering handteres ikke under realisering.", "Niva 2: Store endringer i disponering handteres.", "Niva 3: Systematisk revisjon av disponering.", "Niva 4: Dynamisk tilpasning av disponering.", "Niva 5: Optimal disponering under realisering."]},
        {"id": 13, "title": "Maling av effektivitet og produktivitet", "question": "Hvordan males og forbedres effektivitet og produktivitet under realiseringen?", "scale": ["Niva 1: Effektivitet og produktivitet males ikke.", "Niva 2: Noen malinger registreres.", "Niva 3: Systematisk maling og rapportering.", "Niva 4: Malinger brukes til forbedring.", "Niva 5: Kontinuerlig forbedring basert pa malinger."]},
        {"id": 14, "title": "Operasjonell risiko og ulemper", "question": "Hvordan handteres operasjonelle risikoer og ulemper under realiseringen?", "scale": ["Niva 1: Risikoer og ulemper handteres ikke.", "Niva 2: Store risikoer handteres reaktivt.", "Niva 3: Systematisk identifisering og handtering.", "Niva 4: Proaktiv risikohandtering.", "Niva 5: Risikostyring integrert i realiseringsarbeid."]},
        ...
        {"id": 18, "title": "Endringsberedskap og operativ mottaksevne", "question": "Hvordan utvikles endringsberedskap og mottaksevne under realiseringen?", "scale": ["Niva 1: Endringsberedskap utvikles ikke.", "Niva 2: Begrenset fokus pa endringsberedskap.", "Niva 3: Systematisk arbeid med endringsberedskap.", "Niva 4: Malrettet utvikling av mottaksevne.", "Niva 5: Hoy mottaksevne og endringsberedskap."]},
        ...
        {"id": 22, "title": "Realisme og engasjement", "question": "Hvordan opprettholdes realisme og engasjement under realiseringen?", "scale": ["Niva 1: Realisme og engasjement avtar.", "Niva 2: Begrenset fokus pa a opprettholde engasjement.", "Niva 3: Arbeid med a opprettholde realisme og engasjement.", "Niva 4: Systematisk arbeid for a styrke troverdighet.", "Niva 5: Hoy troverdighet og engasjement."]},
        ...
        {"id": 24, "title": "Enighet og lojalitet til gevinster", "question": "I hvilken grad har endringsledelsesarbeidet resultert i vedvarende enighet og lojalitet til gevinstene nar realiseringen pagar?", "scale": ["Niva 1: Lav enighet - motstand eller tilbaketrekning fra gevinstarbeidet i berort organisasjon.", "Niva 2: Delvis enighet - oppslutningen varierer og enkelte grupper trekker seg fra gevinstarbeidet.", "Niva 3: Moderat enighet - de fleste fortsetter a stotte gevinstene, men engasjementet svinger.", "Niva 4: Hoy enighet - vedvarende stotte og lojalitet til gevinstene gjennom realiseringsfasen.", "Niva 5: Full lojalitet - sterkt eierskap til gevinstene, berort personell tar aktivt ansvar for a sikre varig realisering."]}
    ],
    "Realisert": [
        {"id": 1, "title": "Bruk av tidligere laering og gevinstdata", "question": "I hvilken grad er laering fra gevinstrealiseringen dokumentert, delt og integrert i organisasjonens metodeverk for fremtidige initiativer?", "scale": ["Niva 1: Ingen systematisk dokumentasjon av laering eller erfaringer fra gevinstrealiseringen.", "Niva 2: Enkelte erfaringer er notert, men ikke strukturert eller tilgjengeliggjort for andre.", "Niva 3: Laering er dokumentert i sluttrapport, men ikke aktivt delt eller integrert i metodeverk.", "Niva 4: Erfaringer er systematisk dokumentert, delt i relevante fora, og brukes i planlegging av nye initiativer.", "Niva 5: Laering er fullt integrert i organisasjonens kunnskapsbase, metodeverk og opplaering, med sporbar effekt pa nye initiativer."]},
        {"id": 2, "title": "Strategisk retning og gevinstforstaelse", "question": "I hvilken grad har de realiserte gevinstene faktisk bidratt til organisasjonens strategiske mal, og er denne koblingen dokumentert og verifisert?", "scale": ["Niva 1: Ingen dokumentert kobling mellom realiserte gevinster og strategiske mal.", "Niva 2: Antatt kobling til strategi, men ikke malt eller verifisert.", "Niva 3: Delvis dokumentert strategisk effekt for hovedgevinster.", "Niva 4: Klar dokumentasjon av hvordan gevinstene har bidratt til spesifikke strategiske mal med maltall.", "Niva 5: Full sporbarhet fra realiserte gevinster til strategisk maloppnaelse, verifisert gjennom KPI-er og rapportert til ledelsen."]},
        {"id": 3, "title": "Gevinstkart og visualisering", "question": "Er gevinstkartet oppdatert med faktisk realiserte verdier, og brukes det som referanse for fremtidige initiativer og kommunikasjon av oppnadde resultater?", "scale": ["Niva 1: Gevinstkartet er ikke oppdatert eller brukt etter realisering.", "Niva 2: Kartet eksisterer, men viser fortsatt planlagte verdier uten oppdatering.", "Niva 3: Gevinstkartet er delvis oppdatert med realiserte verdier for hovedgevinster.", "Niva 4: Kartet er fullt oppdatert med realiserte verdier og brukes i sluttrapportering.", "Niva 5: Gevinstkartet er oppdatert, arkivert som referanse, og brukes aktivt i kommunikasjon og som mal for nye initiativer."]},
        {"id": 4, "title": "Strategisk kobling og KPI-er", "question": "Er de realiserte gevinstene malt og rapportert gjennom etablerte KPI-er, og er effekten synlig i organisasjonens styringssystem?", "scale": ["Niva 1: Ingen maling av realiserte gevinster gjennom KPI-er.", "Niva 2: Enkelte malinger finnes, men er ikke koblet til organisasjonens KPI-struktur.", "Niva 3: Hovedgevinster er malt og rapportert, men ikke integrert i lopende styring.", "Niva 4: Realiserte gevinster er malt gjennom KPI-er og rapporteres i styringsdialog.", "Niva 5: Full integrasjon der realiserte gevinster er synlige i dashboards, styringssystem og pavirker ressursallokering."]},
        ...
        {"id": 6, "title": "Nullpunkter og estimater", "question": "Hvordan samsvarer de realiserte gevinstene med opprinnelige estimater, og er avvik analysert og forklart?", "scale": ["Niva 1: Ingen sammenligning mellom estimater og realiserte verdier.", "Niva 2: Overordnet sammenligning uten detaljert avviksanalyse.", "Niva 3: Avvik er identifisert for hovedgevinster med generelle forklaringer.", "Niva 4: Systematisk avviksanalyse med dokumenterte arsaker og laering for fremtidige estimater.", "Niva 5: Detaljert analyse av estimatpresisjon brukes aktivt til a forbedre estimeringsmetodikk i organisasjonen."]},
        {"id": 7, "title": "Hypotesetesting og datagrunnlag", "question": "Er de opprinnelige hypotesene om gevinstmekanismer validert eller falsifisert basert pa faktiske data, og er denne laringen dokumentert?", "scale": ["Niva 1: Ingen systematisk validering av opprinnelige hypoteser.", "Niva 2: Generell vurdering av om hypoteser stemte uten datagrunnlag.", "Niva 3: Hovedhypoteser er vurdert mot faktiske resultater med noe dokumentasjon.", "Niva 4: Systematisk validering av hypoteser med datagrunnlag og dokumenterte konklusjoner.", "Niva 5: Full hypotesevalidering integrert i laeringsrapport, med innsikt som forbedrer fremtidige gevinstmodeller."]},
        {"id": 8, "title": "Interessentengasjement", "question": "Hvordan vurderer interessentene selv sin involvering i gevinstrealiseringen, og er deres tilbakemeldinger innhentet og dokumentert?", "scale": ["Niva 1: Ingen systematisk innhenting av interessenters vurdering.", "Niva 2: Uformelle tilbakemeldinger fra enkelte interessenter.", "Niva 3: Strukturert tilbakemelding innhentet fra hovedinteressenter.", "Niva 4: Omfattende interessentevaluering med dokumenterte funn og forbedringsomrader.", "Niva 5: Interessentvurdering integrert i sluttrapport, med konkrete tiltak for forbedring av fremtidig involvering."]},
        {"id": 9, "title": "Gevinstforutsetninger", "question": "I hvilken grad ble de identifiserte gevinstforutsetningene faktisk oppfylt, og hvordan pavirket dette gevinstrealiseringen?", "scale": ["Niva 1: Ingen systematisk oppfolging av om forutsetninger ble oppfylt.", "Niva 2: Generell vurdering uten konkret dokumentasjon av forutsetningsstatus.", "Niva 3: Hovedforutsetninger er vurdert med dokumentasjon av oppfyllelsesgrad.", "Niva 4: Systematisk analyse av forutsetningsoppfyllelse og pavirkning pa gevinster.", "Niva 5: Full sporbarhet fra forutsetninger til gevinstresultat, med laering om kritiske forutsetninger for fremtiden."]},
        {"id": 10, "title": "Prinsipielle og vilkarsmessige kriterier", "question": "Ble alle identifiserte kriterier og vilkar for gevinstrealisering oppfylt, og er eventuelle avvik handtert og dokumentert?", "scale": ["Niva 1: Ingen oppfolging av om kriterier og vilkar ble oppfylt.", "Niva 2: Generell vurdering uten systematisk gjennomgang.", "Niva 3: Hovedkriterier er gjennomgatt med dokumentasjon av status.", "Niva 4: Systematisk gjennomgang av alle kriterier med avvikshåndtering dokumentert.", "Niva 5: Full dokumentasjon av kriterieoppfyllelse integrert i sluttrapport med laering for fremtidige initiativer."]},
        {"id": 11, "title": "Enighet om nullpunkter/estimater", "question": "Er det oppnadd enighet blant interessenter om de endelige gevinstresultatene, og er eventuelle uenigheter lost eller dokumentert?", "scale": ["Niva 1: Ingen formell enighet om gevinstresultater - ulike oppfatninger eksisterer.", "Niva 2: Delvis enighet, men med uloste uenigheter om sentrale gevinster.", "Niva 3: Enighet om hovedresultater, men noen omrader har fortsatt uavklarte sporsmal.", "Niva 4: Bred enighet om gevinstresultater dokumentert gjennom formell godkjenning.", "Niva 5: Full konsensus om alle gevinstresultater, med transparent prosess og dokumentert godkjenning fra alle nokkelinteressenter."]},
        {"id": 12, "title": "Disponering av kostnads- og tidsbesparelser", "question": "Er frigjorte ressurser fra kostnads- og tidsbesparelser faktisk omdisponert som planlagt, og er denne omdisponeringen dokumentert og verifisert?", "scale": ["Niva 1: Ingen dokumentasjon av hvordan frigjorte ressurser er disponert.", "Niva 2: Pastand om omdisponering uten konkret dokumentasjon eller verifisering.", "Niva 3: Delvis dokumentert omdisponering for hovedbesparelser.", "Niva 4: Systematisk dokumentasjon av ressursomdisponering med verifisering fra budsjettansvarlige.", "Niva 5: Full sporbarhet av frigjorte ressurser til ny verdiskapende aktivitet, rapportert i okonomioppfolging."]},
        {"id": 13, "title": "Maling av effektivitet og produktivitet", "question": "Er okt effektivitet og produktivitet malt over tid for a verifisere at gevinstene er varige, ikke bare kortvarige effekter?", "scale": ["Niva 1: Ingen maling av om effektivitetsgevinster opprettholdes over tid.", "Niva 2: Enkeltmaling ved prosjektslutt uten oppfolging.", "Niva 3: Malinger gjennomfort i en periode etter realisering med noe dokumentasjon.", "Niva 4: Systematisk maling over tid som bekrefter varige effekter.", "Niva 5: Langsiktig malingsprogram etablert som del av linjeorganisasjonens oppfolging, med dokumentert baerekraft."]},
        {"id": 14, "title": "Operasjonell risiko og ulemper", "question": "Er de faktiske ulempene og negative konsekvensene kartlagt og vurdert opp mot de realiserte gevinstene i en helhetlig kost-nytte-vurdering?", "scale": ["Niva 1: Ingen kartlegging av faktiske ulemper eller negativ pavirkning.", "Niva 2: Uformell erkjennelse av noen ulemper uten systematisk vurdering.", "Niva 3: Hovedulemper er identifisert og vurdert mot gevinster.", "Niva 4: Systematisk kost-nytte-analyse med dokumenterte ulemper og gevinster.", "Niva 5: Helhetlig evaluering med transparent vurdering av netto verdiskapning, inkludert alle vesentlige ulemper."]},
        ...
        {"id": 16, "title": "Dokumentasjon og gevinstrealiseringsplan", "question": "Er gevinstrealiseringsplanen oppdatert med faktiske resultater og arkivert som referansedokument for organisasjonen?", "scale": ["Niva 1: Gevinstrealiseringsplanen er ikke oppdatert eller arkivert.", "Niva 2: Planen eksisterer, men er ikke oppdatert med faktiske resultater.", "Niva 3: Planen er delvis oppdatert med hovedresultater.", "Niva 4: Planen er fullt oppdatert med alle resultater og avvik dokumentert.", "Niva 5: Oppdatert plan er arkivert som beste praksis-referanse og brukes aktivt i opplaering og nye initiativer."]},
        {"id": 17, "title": "Gevinstrealiseringsplan som operativ handlingsplan", "question": "Fungerte gevinstrealiseringsplanen effektivt som operativt styringsverktoy gjennom hele realiseringen, og er erfaringene med dette dokumentert?", "scale": ["Niva 1: Planen ble ikke brukt operativt - kun et plandokument.", "Niva 2: Planen ble brukt sporadisk uten systematisk oppfolging.", "Niva 3: Planen ble brukt som styringsverktoy for deler av realiseringen.", "Niva 4: Planen fungerte som aktivt styringsverktoy med regelmessig oppdatering og oppfolging.", "Niva 5: Planen var sentralt styringsverktoy gjennom hele realiseringen, med dokumenterte erfaringer for metodeforbedring."]},
        {"id": 18, "title": "Endringsberedskap og operativ mottaksevne", "question": "Hadde organisasjonen tilstrekkelig kapasitet og kompetanse til a ta imot og forankre endringene varig, og er dette evaluert?", "scale": ["Niva 1: Ingen evaluering av organisasjonens mottaksevne eller endringskapasitet.", "Niva 2: Uformell vurdering uten systematisk evaluering.", "Niva 3: Evaluering gjennomfort for hovedomrader med noe dokumentasjon.", "Niva 4: Systematisk evaluering av mottaksevne med dokumenterte funn og forbedringsomrader.", "Niva 5: Omfattende evaluering med konkrete anbefalinger implementert for a styrke fremtidig endringskapasitet."]},
        {"id": 19, "title": "Kommunikasjon og forankring", "question": "Er de realiserte gevinstene kommunisert til organisasjonen, og oppleves endringene som varig forankret i kultur og arbeidsprosesser?", "scale": ["Niva 1: Ingen systematisk kommunikasjon av oppnadde resultater.", "Niva 2: Begrenset kommunikasjon til utvalgte grupper.", "Niva 3: Resultater kommunisert bredt, men usikkert om varig forankring.", "Niva 4: Systematisk kommunikasjon med dokumentert forankring i berort organisasjon.", "Niva 5: Gevinstene er kommunisert som suksesshistorie, og endringene er observerbart integrert i daglig praksis og kultur."]},
        {"id": 20, "title": "Eierskap og ansvar", "question": "Er det etablert varig eierskap i linjen for a opprettholde de realiserte gevinstene, og er ansvar og roller for vedlikehold definert?", "scale": ["Niva 1: Ingen definert eierskap for vedlikehold av gevinster etter prosjektslutt.", "Niva 2: Uformelt eierskap uten klare roller eller ansvar.", "Niva 3: Eierskap definert for hovedgevinster, men ikke fullt operasjonalisert.", "Niva 4: Klart definert eierskap med roller og ansvar dokumentert og overfort til linjen.", "Niva 5: Varig eierskap etablert med integrering i stillingsbeskrivelser, malstyring og oppfolgingsrutiner."]},
...
def get_score_text(score):
    if score >= 4.5: return "Hoy modenhet"
