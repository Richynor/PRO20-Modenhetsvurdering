...
ROLES = {
    ...
    "Linjeleder / Mottaker": {
        ...
        "recommended_questions": {
            ...
            "Gjennomforing": [2, 8, 9, 12, 13, 17, 18, 19, 20, 22],
    ...
    "Styringsgruppe": {
        ...
        "recommended_questions": {
            ...
            "Gjennomforing": [2, 4, 8, 14, 16, 19, 20, 22],
    ...
    "Endringsleder": {
        ...
        "recommended_questions": {
            ...
            "Gjennomforing": [2, 8, 9, 18, 19, 20, 22, 23],
    ...
    "Interessent": {
        ...
        "recommended_questions": {
            ...
            "Gjennomforing": [8, 9, 12, 13, 18, 19, 22],
...
questions_data = {
    ...
    "Realisert": [
        {"id": 1, "title": "Bruk av tidligere laering og gevinstdata", "question": "Hvordan dokumenteres og deles laering fra gevinstrealiseringen for fremtidig bruk?", "scale": ["Niva 1: Ingen dokumentasjon eller deling av laering.", "Niva 2: Enkelte erfaringer deles uformelt.", "Niva 3: Systematisk dokumentasjon av laering.", "Niva 4: Laering deles og diskuteres i organisasjonen.", "Niva 5: Laering integrert i organisasjonens kunnskapsbase."]},
        {"id": 2, "title": "Strategisk retning og gevinstforstaelse", "question": "Hvordan bidro den strategiske retningen til gevinstrealiseringens suksess?", "scale": ["Niva 1: Strategisk retning bidro lite til suksess.", "Niva 2: Strategi var viktig for enkelte gevinster.", "Niva 3: Strategi bidro til flere gevinster.", "Niva 4: Strategi var avgjorende for gevinstrealisering.", "Niva 5: Strategi og gevinstrealisering fullt integrert."]},
        {"id": 3, "title": "Gevinstkart og visualisering", "question": "Hvordan bidro gevinstkartet til gevinstrealiseringens suksess?", "scale": ["Niva 1: Gevinstkartet bidro lite til suksess.", "Niva 2: Kartet var nyttig for enkelte gevinster.", "Niva 3: Kartet bidro til flere gevinster.", "Niva 4: Kartet var viktig for gevinstrealisering.", "Niva 5: Kartet var avgjorende for suksess."]},
        {"id": 4, "title": "Strategisk kobling og KPI-er", "question": "Hvordan bidro den strategiske koblingen og KPI-ene til gevinstrealisering?", "scale": ["Niva 1: Strategisk kobling bidro lite.", "Niva 2: Kobling var viktig for enkelte gevinster.", "Niva 3: Kobling bidro til flere gevinster.", "Niva 4: Kobling var avgjorende for realisering.", "Niva 5: Full integrasjon mellom strategi og realisering."]},
        {"id": 5, "title": "Avgrensning av programgevinst", "question": "Hvordan bidro avgrensningsarbeidet til gevinstrealiseringens troverdighet?", "scale": ["Niva 1: Avgrensning bidro lite til troverdighet.", "Niva 2: Avgrensning viktig for enkelte gevinster.", "Niva 3: Avgrensning bidro til troverdighet for flere gevinster.", "Niva 4: Avgrensning var avgjorende for troverdighet.", "Niva 5: Avgrensning styrket troverdighet betydelig."]},
        {"id": 6, "title": "Nullpunkter og estimater", "question": "Hvordan bidro nullpunkter og estimater til gevinstrealiseringens noyaktighet?", "scale": ["Niva 1: Nullpunkter og estimater bidro lite.", "Niva 2: Estimater var noyaktige for enkelte gevinster.", "Niva 3: Estimater var noyaktige for flere gevinster.", "Niva 4: Hoy noyaktighet i estimater.", "Niva 5: Estimater var svaert noyaktige."]},
        {"id": 7, "title": "Hypotesetesting og datagrunnlag", "question": "Hvordan bidro hypotesetesting og datagrunnlag til gevinstrealiseringens kvalitet?", "scale": ["Niva 1: Testing og datagrunnlag bidro lite.", "Niva 2: Testing viktig for enkelte gevinster.", "Niva 3: Testing bidro til kvalitet for flere gevinster.", "Niva 4: Testing var avgjorende for kvalitet.", "Niva 5: Testing og datagrunnlag styrket kvalitet betydelig."]},
        {"id": 8, "title": "Interessentengasjement", "question": "Hvordan bidro interessentengasjement til gevinstrealiseringens suksess?", "scale": ["Niva 1: Interessentengasjement bidro lite.", "Niva 2: Engasjement viktig for enkelte gevinster.", "Niva 3: Engasjement bidro til flere gevinster.", "Niva 4: Engasjement var avgjorende for suksess.", "Niva 5: Interessenter var drivkrefter for suksess."]},
        {"id": 9, "title": "Gevinstforutsetninger", "question": "Hvordan bidro handtering av gevinstforutsetninger til realiseringens suksess?", "scale": ["Niva 1: Forutsetningshandtering bidro lite.", "Niva 2: Handtering viktig for enkelte gevinster.", "Niva 3: Handtering bidro til flere gevinster.", "Niva 4: Handtering var avgjorende for suksess.", "Niva 5: Forutsetningshandtering var suksessfaktor."]},
        {"id": 10, "title": "Prinsipielle og vilkarsmessige kriterier", "question": "Hvordan bidro handtering av kriterier til gevinstrealisering?", "scale": ["Niva 1: Kriteriehandtering bidro lite.", "Niva 2: Handtering viktig for enkelte gevinster.", "Niva 3: Handtering bidro til flere gevinster.", "Niva 4: Handtering var avgjorende for realisering.", "Niva 5: Kriteriehandtering styrket realisering."]},
        {"id": 11, "title": "Enighet om nullpunkter/estimater", "question": "Hvordan bidro enighet om nullpunkter og estimater til realiseringens suksess?", "scale": ["Niva 1: Enighet bidro lite til suksess.", "Niva 2: Enighet viktig for enkelte gevinster.", "Niva 3: Enighet bidro til flere gevinster.", "Niva 4: Enighet var avgjorende for suksess.", "Niva 5: Full enighet styrket suksess betydelig."]},
        {"id": 12, "title": "Disponering av kostnads- og tidsbesparelser", "question": "Hvordan bidro disponering av besparelser til gevinstrealiseringens verdiskapning?", "scale": ["Niva 1: Disponering bidro lite til verdiskapning.", "Niva 2: Disponering viktig for enkelte gevinster.", "Niva 3: Disponering bidro til verdi for flere gevinster.", "Niva 4: Disponering var avgjorende for verdiskapning.", "Niva 5: Optimal disponering maksimerte verdi."]},
        {"id": 13, "title": "Maling av effektivitet og produktivitet", "question": "Hvordan bidro maling av effektivitet og produktivitet til gevinstrealisering?", "scale": ["Niva 1: Maling bidro lite til realisering.", "Niva 2: Maling viktig for enkelte gevinster.", "Niva 3: Maling bidro til flere gevinster.", "Niva 4: Maling var avgjorende for realisering.", "Niva 5: Maling drevet gevinstrealisering."]},
        {"id": 14, "title": "Operasjonell risiko og ulemper", "question": "Hvordan bidro handtering av risiko og ulemper til gevinstrealiseringens robusthet?", "scale": ["Niva 1: Risikohandtering bidro lite.", "Niva 2: Handtering viktig for enkelte gevinster.", "Niva 3: Handtering bidro til robusthet for flere gevinster.", "Niva 4: Handtering var avgjorende for robusthet.", "Niva 5: Risikohandtering styrket robusthet betydelig."]},
        {"id": 15, "title": "Balanse mellom gevinster og ulemper", "question": "Hvordan bidro balansevurdering til gevinstrealiseringens baerekraft?", "scale": ["Niva 1: Balansevurdering bidro lite.", "Niva 2: Vurdering viktig for enkelte gevinster.", "Niva 3: Vurdering bidro til baerekraft for flere gevinster.", "Niva 4: Vurdering var avgjorende for baerekraft.", "Niva 5: Balansevurdering styrket baerekraft betydelig."]},
        {"id": 16, "title": "Dokumentasjon og gevinstrealiseringsplan", "question": "Hvordan bidro gevinstrealiseringsplanen til gevinstrealiseringens suksess?", "scale": ["Niva 1: Planen bidro lite til suksess.", "Niva 2: Planen viktig for enkelte gevinster.", "Niva 3: Planen bidro til flere gevinster.", "Niva 4: Planen var avgjorende for suksess.", "Niva 5: Planen var suksessfaktor for realisering."]},
        {"id": 17, "title": "Gevinstrealiseringsplan som operativ handlingsplan", "question": "Hvordan bidro gevinstrealiseringsplanen som operativ handlingsplan til suksess?", "scale": ["Niva 1: Planen som handlingsplan bidro lite.", "Niva 2: Planen viktig for enkelte operasjoner.", "Niva 3: Planen bidro til flere operasjoner.", "Niva 4: Planen var avgjorende for operativ suksess.", "Niva 5: Planen drevet operativ gevinstrealisering."]},
        {"id": 18, "title": "Endringsberedskap og operativ mottaksevne", "question": "Hvordan bidro endringsberedskap og mottaksevne til gevinstrealisering?", "scale": ["Niva 1: Beredskap og mottaksevne bidro lite.", "Niva 2: Beredskap viktig for enkelte gevinster.", "Niva 3: Beredskap bidro til flere gevinster.", "Niva 4: Beredskap var avgjorende for realisering.", "Niva 5: Hoy mottaksevne drevet realisering."]},
        {"id": 19, "title": "Kommunikasjon og forankring", "question": "Hvordan bidro kommunikasjon og forankring til gevinstrealiseringens suksess?", "scale": ["Niva 1: Kommunikasjon bidro lite til suksess.", "Niva 2: Kommunikasjon viktig for enkelte gevinster.", "Niva 3: Kommunikasjon bidro til flere gevinster.", "Niva 4: Kommunikasjon var avgjorende for suksess.", "Niva 5: God kommunikasjon styrket suksess betydelig."]},
        {"id": 20, "title": "Eierskap og ansvar", "question": "Hvordan bidro eierskap og ansvar til gevinstrealiseringens suksess?", "scale": ["Niva 1: Eierskap og ansvar bidro lite.", "Niva 2: Eierskap viktig for enkelte gevinster.", "Niva 3: Eierskap bidro til flere gevinster.", "Niva 4: Eierskap var avgjorende for suksess.", "Niva 5: Sterkt eierskap drevet suksess."]},
        {"id": 21, "title": "Periodisering og forankring", "question": "Hvordan bidro periodisering og forankring til gevinstrealiseringens effektivitet?", "scale": ["Niva 1: Periodisering bidro lite til effektivitet.", "Niva 2: Periodisering viktig for enkelte gevinster.", "Niva 3: Periodisering bidro til effektivitet for flere gevinster.", "Niva 4: Periodisering var avgjorende for effektivitet.", "Niva 5: God periodisering maksimerte effektivitet."]},
        {"id": 22, "title": "Realisme og engasjement", "question": "Hvordan bidro realisme og engasjement til gevinstrealiseringens troverdighet?", "scale": ["Niva 1: Realisme og engasjement bidro lite.", "Niva 2: Realisme viktig for enkelte gevinster.", "Niva 3: Realisme bidro til troverdighet for flere gevinster.", "Niva 4: Realisme var avgjorende for troverdighet.", "Niva 5: Hoy troverdighet styrket realisering."]},
        {"id": 23, "title": "Bygge momentum og tidlig gevinstuttak", "question": "Hvordan bidro arbeid med momentum og tidlig gevinstuttak til langsiktig suksess?", "scale": ["Niva 1: Momentum og tidlig uttak bidro lite.", "Niva 2: Tidlig uttak viktig for enkelte gevinster.", "Niva 3: Tidlig uttak bidro til momentum for flere gevinster.", "Niva 4: Momentum var avgjorende for suksess.", "Niva 5: Momentum og tidlig uttak drevet langsiktig suksess."]}
    ]
}
